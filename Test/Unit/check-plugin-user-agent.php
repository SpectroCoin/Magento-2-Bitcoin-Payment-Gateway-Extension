 ...
 *
 * Run:  php Test/Unit/check-plugin-user-agent.php
 */
...
$root   = __DIR__ . '/../../';
$source = file_get_contents($root . 'Library/SCMerchantClient/SCMerchantClient.php');
...
$t = new TestRunner();
echo "SpectroCoin Magento2 — plugin identification header\n\n";
